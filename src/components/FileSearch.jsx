...
import { formatDateFunction, minorHeadOptions } from "../util/helper";
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const apiPayload = {
                ...
                from_date: formatDateFunction(documentFromDate) || "",
                to_date: formatDateFunction(documentToDate) || "",
                start: 0,
            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        Find documents quickly using our advanced search filters and tag
                        suggestions
                    </p>
                </div>
