...
const FileUpload = () => {
    ...
    const user = JSON.parse(localStorage.getItem("users"))[0].username || [];
    ...
    const [uploadedBy, setUploadedBy] = useState(user || "admin");
    ...
    const handleAddTag = (tagObj) => {
        ...
        if (
            !tags.some(
                (t) => t.tag_name.toLowerCase() === newTag.tag_name.toLowerCase()
            )
        ) {
            setTags([...tags, newTag]);
        }
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center justify-center w-full">
                            <label
                                className={`flex flex-col items-center justify-center w-full h-32 border-2 ${file
                                    ? "border-green-500"
                                    : errors.file
                                        ? "border-red-500"
                                        : "border-gray-300"
                                ...
                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                    {file ? (
                                        <>
                                            ...
                                            <p className="mb-2 text-sm text-gray-500 mt-2 truncate max-w-xs">
                                                {file.name}
                                            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <DatePicker
                                ...
                                className={`w-full p-3 border rounded-lg focus:ring-2 focus:outline-none transition ${errors.documentDate
                                    ? "border-red-500 focus:ring-red-300"
                                    : "border-gray-300 focus:ring-purple-300 focus:border-purple-500"
                                    }`}
                            />
                            {errors.documentDate && (
                                <p className="text-sm text-red-600">{errors.documentDate}</p>
                            )}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                ...
                                className={`w-full p-3 border rounded-lg focus:ring-2 focus:outline-none transition ${errors.majorHead
                                    ? "border-red-500 focus:ring-red-300"
                                    : "border-gray-300 focus:ring-purple-300 focus:border-purple-500"
                                    }`}
                            >
                            ...
                            {errors.majorHead && (
                                <p className="text-sm text-red-600">{errors.majorHead}</p>
                            )}
                        </div>
                    </div>
                    ...
                    {majorHead && (
                        <div className="space-y-2">
                            <label
                                ...
                                className="block text-sm font-medium text-gray-700"
                            >
                                {labelMap[majorHead] || "Subcategory"}{" "}
                            ...
                            <select
                                ...
                                className={`w-full p-3 border rounded-lg focus:ring-2 focus:outline-none transition ${errors.minorHead
                                    ? "border-red-500 focus:ring-red-300"
                                    : "border-gray-300 focus:ring-purple-300 focus:border-purple-500"
                                    }`}
                            >
                            ...
                            {errors.minorHead && (
                                <p className="text-sm text-red-600">{errors.minorHead}</p>
                            )}
                        </div>
                    )}
