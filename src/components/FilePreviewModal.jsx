            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="flex-1 overflow-auto p-6">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        {/* Preview */}
                        <div
                            className="lg:col-span-2 border border-gray-200 rounded-xl overflow-hidden bg-gray-50"
                            ...
                            <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-5">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-gray-800">
                                            {file.uploadDate || file.document_date || "N/A"}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-gray-800">
                                            {file.user_id || file.uploaded_by || "Unknown"}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-gray-800">
                                            {file.document_remarks || file.remarks || "N/A"}
                                        </p>
                                    </div>
                                        ...
                                        <div className="flex flex-wrap gap-2 mt-1">
                                            {file.tags && file.tags.length > 0 ? (
                                                file.tags.map((tag, i) => (
                                                    <span
                                                        key={i}
                                                        className="bg-gradient-to-r from-purple-100 to-blue-100 text-purple-800 px-3 py-1 rounded-full text-xs font-medium"
                                                    >
                                                        {tag.tag_name || tag}
                                                    </span>
                                                ))
